...
namespace UnityQuickSheet
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "QuickSheet/Setting/Excel Updater")]
    public class ExcelUpdater : SingletonScriptableObject<ExcelUpdater>
    {
        /// <summary>
        ...
        /// </summary>
        [MenuItem("Edit/Project Settings/QuickSheet/Select Excel Updater")]
        public static void Edit()
        {
            Selection.activeObject = Instance;
            if (Selection.activeObject == null)
            {
                Debug.LogError(@"No ExcelUpdater.asset file is found. Create setting file first. See the menu at 'Create/QuickSheet/Setting/Excel Updater'.");
            }
        }
    }
}
